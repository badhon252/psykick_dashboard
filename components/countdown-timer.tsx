...
export function CountdownTimer({ endTime, onComplete, showSetOutcomeButton = false, targetId }: CountdownTimerProps) {
  ...
  return (
    <div className="bg-[#170A2C] p-3 rounded-md text-center">
      {isCompleted && showSetOutcomeButton ? (
        ...
        <>
          ...
          <div className="flex gap-2 text-white">
            <div className="bg-[#170A2C] p-1 rounded">
